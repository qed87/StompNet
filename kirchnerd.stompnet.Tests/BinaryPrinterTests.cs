        ...
        get
        {
            return new[]
            {
                new object[]
                {
                    ...
                    $"b2 1c cd 1f 79 91 1a 5c{Environment.NewLine}"
                },
                new object[]
                {
                    ...
                    $"66 90 06 9b 4a e5 c4 f9 27 55 d3 b5 71 8c 14 31 60 53 f2 21 21 a3 3b c1 47 80 1e b5 13 8e f8 79 66 90 06 9b 4a e5 c4 f9 27 55 d3 b5 71 8c 14 31 60 53 f2 21 21 a3 3b c1 47 80 1e b5 13 8e f8 79{Environment.NewLine}79{Environment.NewLine}"
                },
                new object[]
                {
                    ...
                    $"66 90 06 9b 4a e5 c4 f9 27 55 d3 b5 71 8c 14 31 60 53 f2 21 21 a3 3b c1 47 80 1e b5 13 8e f8 79 66 90 06 9b 4a e5 c4 f9 27 55 d3 b5 71 8c 14 31 60 53 f2 21 21 a3 3b c1 47 80 1e b5 13 8e f8 79{Environment.NewLine}"
                },
            };
        }
    }
